...
namespace Textile.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        {
            //check roleis available or not 
            //if role is not available create new role
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, WC.AdminRole);
                        //admin user has logged in and they try to create a new user
                    }
                    else
                    {
